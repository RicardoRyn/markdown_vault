...
paru -S archlinuxcn-keyring # cn 源中的签名（archlinuxcn-keyring 在 archlinuxcn）
```
...
paru -S sof-firmware alsa-firmware alsa-ucm-conf alsa-utils pipewire pipewire-pulse # 声音固件
paru -S brightnessctl                                                               # 亮度控制
paru -S ntfs-3g                                                                     # 使系统可以识别 NTFS 格式的硬盘
paru -S gammastep                                                                   # 夜灯
paru -S adobe-source-han-serif-cn-fonts wqy-zenhei                                  # 安装几个开源中文字体。
paru -S noto-fonts noto-fonts-cjk noto-fonts-emoji noto-fonts-extra                 # 安装谷歌开源字体及表情
paru -S kitty git sublime-text-4
