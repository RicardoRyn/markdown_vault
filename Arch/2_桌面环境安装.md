...
sudo pacman -S brightnessctl                                               # 亮度控制
...
```bash
paru -S zen-browser-bin zen-browser-i18n-zh-cn sublime-text-4
paru -S dgop matugen brightnessctl wl-clipboard cava cliphist gammastep
```
